...
namespace Mapping_Solution.DataAccessLayer.DAL
{
    ...
    public class DalMapPanMapping : IdalMapPanMapping
    {
        ...
        public List<MapPanMappingDetail> GetMapPanMapping(MapSearchActivites e)
        {
            ...
            using (OracleConnection con = new OracleConnection(CustomHelper.CustomHelper.getConnectionStringForMappingInst("MISVPAY_TBL_MAP_PAN_MAPPING_INST", e.region_code)))
            {
