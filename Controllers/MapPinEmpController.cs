...
{
    [CustomAuthorize]
    public class MapPinEmpController : Controller
    {
        // GET: MapPinEmp
        IDalMapPinEmp ex = new DalMapPinEmp();
        ...
        public ActionResult Index(MapSearchActivites e, UfcMasterSearch uf)
        {
            ...
            var a = ex.GetMapPinEmp(e);
            return View(a);
        }

        [HttpPost]
        public JsonResult Update(List<MapPinEmpDetails> objList)
        {
            var result = ex.Update_PINCODE_TO_RM_MAPPING_RTL(objList);

            return Json(result);
        }


        public JsonResult BulkUpdate(MapPinEmpDetails objModel)
        {
            var result = ex.Bulk_Update_Pincode_To_RM(objModel);
        ...
        public ActionResult _MapPinEmpView(MapSearchActivites e)
        {
            ...
            ViewBag.rm_code = new SelectList(emplid, "EmployeeId", "EmployeeName");
            var a = ex.GetMapPinEmp(e);
            return PartialView("_MapPinEmpView", a);
        }
    }
}