...
namespace Mapping_Solution.Controllers
{
    ...
    public class MfdexMapNewcityArnController : Controller
    {
        ...
        IdalMfdexMapNewcityArn map = new DalMfdexMapNewcityArn();
        ...
        public ActionResult Index(MapSearchActivites e, UfcMasterSearch uf)
        {
            ...
            var add = map.Get_MfdexMapNewcityArn_AllDetails(e);

            return View(add);
        }

        public JsonResult Update(List<MfdexMapNewcityArnDetail> objList)
        {
            var result = map.Update_ARN_GROUP_OF_CITIES_TO_RM_MAPPING_RTL(objList);

            return Json(result);
        }

        public JsonResult BulkUpdate(MfdexMapNewcityArnDetail objModel)
        {
            var result = map.Bulk_Update_ArnGroup_of_City(objModel);
