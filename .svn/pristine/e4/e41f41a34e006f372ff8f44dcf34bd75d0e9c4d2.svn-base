...
namespace Mapping_Solution.DataAccessLayer.DAL
{
    public class DalMfdexMapCamsCityArn : IdalMfdexMapCamsCityArn
    {
        ...
        public List<MfdexMapCamsCityArnDetail> Get_MfdexMapCamsCityArn_AllDetails(MapSearchActivites e)
        {
            ...
            using (OracleConnection objConn = new OracleConnection(CustomHelper.CustomHelper.getConnectionStringForMapping("MISV_TBL_ARN_SINGLE_CITY_TO_RM_MAPPING_RTL", e.ufc_name)))
            {
                OracleCommand cmd = new OracleCommand();
                cmd.Connection = objConn;
                cmd.CommandText = "GETALL_MISV_ARN_SINGLE_CITY_TO_RM_MAPPING_RTL";
        ...
        #region Update ARN SINGLE CITY TO RM MAPPING RTL
        public Response Update_ARN_SINGLE_CITY_TO_RM_MAPPING_RTL(List<MfdexMapCamsCityArnDetail> objList)
        {
            ...
            using (OracleConnection con = new OracleConnection(strconTemp))
            {
                ...
                try
                {
                    ...
                    {
                        OracleCommand cmd = new OracleCommand("UPDATE_MISV_TBL_ARN_SINGLE_CITY_TO_RM_MAPPING_RTL", con);
                        cmd.CommandType = CommandType.StoredProcedure;
        ...
        #region Bulk Update Rm Code ARN Single City to Rm Mapping
        public Response Bulk_Update_Arn_Single_city(MfdexMapCamsCityArnDetail objModel)
        {
            Response res = new Response();
            using (OracleConnection con = new OracleConnection(strconTemp))
            {
                ...
                try
                {
                    ...
                    OracleCommand cmd = new OracleCommand("UPDATE_BULK_RMCODE_MISV_TBL_ARN_SINGLE_CITY_TO_RM_MAPPING_RTL", con);
                    cmd.CommandType = CommandType.StoredProcedure;
