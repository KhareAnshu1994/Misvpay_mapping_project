Oracle.EntityFrameworkCore NuGet Package Version 2.19.90 README
===============================================================
...
Bug Fixes since Oracle.EntityFrameworkCore NuGet Package 2.19.80
================================================================
31388650 - SELECT WITH COALESCE OPERATOR INCORRECTLY APPENDS 'N' PREFIX TO CAUSE ORA-12704
31446343 - SCAFFOLDING OPERATION INCORRECTLY GENERATES TWO INDEXES WITH SAME NAME FOR COMPOSITE INDEX
31455464 - SINGLE QUOTES ARE NOT PROPERLY ESCAPED IN MIGRATION SCRIPT
31469664 - SCAFFOLDING WITH BOTH SCHEMA AND TABLE FILTER IS NOT HONORED PROPERLY
31524350 - NULLS FIRST IS APPLIED ALWAYS REGARDLESS OF ORDERBY OR ORDERBYDESCENDING
31530307 - EFCORE: 3.1: ERROR CASTING ENUM INSIDE LINQ WHERE CLAUSE
31661791 - RAISE_APPLICATION_ERROR -20001 RETURNS INCORRECT "REQUIRED USER DOES NOT EXIST" ERROR
...
If the string entity property is associated with a VARCHAR2 column, make sure that string entity property has either
- IsUnicode(false), or
- HasColumnType("VARCHAR2(<length>)")
fluent APIs invoked to bind the data as VARCHAR2.

If the string entity property is associated with a NVARCHAR2 column, make sure that string entity property has either
